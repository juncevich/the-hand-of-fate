...
fun RefreshTokenJpaEntity.toDomain() =
    RefreshToken(
        id = id,
        user = user.toDomain(),
        tokenHash = tokenHash,
...
fun RefreshToken.toJpaEntity(userEntity: UserJpaEntity) =
...
fun TelegramLinkTokenJpaEntity.toDomain() =
    TelegramLinkToken(
        id = id,
        user = user.toDomain(),
        token = token,
...
fun TelegramLinkToken.toJpaEntity(userEntity: UserJpaEntity) =
